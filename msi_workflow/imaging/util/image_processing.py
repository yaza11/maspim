...
from msi_workflow.imaging.util.image_convert_types import (
    convert, ensure_image_is_gray, infer_mode)
...
def adaptive_mean_with_mask(
    ...
    mask : array[bool], optional
        The mask to use with the same width and height as msi_workflow.
        The default is None.

    Returns
    -------
    dst : array[bool]
        Same shape as msi_workflow. The classified values for each pixel. If pixel is
    ...
    # by how many pixels the msi_workflow will be extended
