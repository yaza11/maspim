...
def test_image_flow():
    ...
    I1.load()
    # target
    image0 = downscale_local_mean(I0.image_grayscale(), 2)
    # moving
    image1 = resize(I1.image_grayscale(), image0.shape)
...
def test_SIFT():
    ...
    I1.load()
    # target
    img1 = downscale_local_mean(I0.image_grayscale(), 16)
    # moving
    img2 = downscale_local_mean(I1.image_grayscale(), 16)
...
if __name__ == '__main__':
    ...
    #     image_gray=IROI.image_grayscale(),
