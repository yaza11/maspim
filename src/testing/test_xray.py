...
xray = XRay(path_image_file=path_xray, depth_section=(480, 510))
# xray.get_sample_area_box(plts=True)
xray.get_sample_area_box(plts=True)
...
# image = IR._require_simplified_image() * IR._require_foreground_thr_and_pixels()[1]
