...
def test_(section, window):
    ...
    DC.plt_comp('classification', exclude_holes=False)
    DC.plt_comp(443.136)
    # DC.plts = True
    # DC.sget_photo_ROI()
    # DC.plt_comp('classification')
    # DC.plt_comp('classification_s')
    # DC.plt_comp('seed')
    return DC
...
if __name__ == '__main__':
    ...
    # a.plt_comp(mC37_2, exclude_holes=False)
    # print(
    ...
    # m.plt_comp('classification', exclude_holes=False)

    # u, l = m.split_at_depth(YD_transition_depth)
    # u.plt_comp('classification', exclude_holes=False)
    # l.plt_comp('classification', exclude_holes=False)
    pass
