...
def adaptive_mean_with_mask(
    ...
    mask : array[bool], optional
        The mask to use with the same width and height as maspim.
        The default is None.

    Returns
    -------
    dst : array[bool]
        Same shape as maspim. The classified values for each pixel. If pixel is
    ...
    # by how many pixels the maspim will be extended
